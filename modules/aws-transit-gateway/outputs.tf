...
output "ec2_transit_gateway_route_table_prod_id" {
  description = "EC2 Transit Gateway Route Table identifier"
  value       = element(concat(aws_ec2_transit_gateway_route_table.production.*.id, [""]), 0)
}

output "ec2_transit_gateway_route_table_non_prod_id" {
  description = "EC2 Transit Gateway Route Table identifier"
  value       = element(concat(aws_ec2_transit_gateway_route_table.non_production.*.id, [""]), 0)
}
