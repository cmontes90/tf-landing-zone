...
variable "transit_gateway_route_table_prod_id" {
  description = "Identifier of EC2 Transit Gateway Route Table to use with the Target Gateway when reusing it between multiple TGWs"
  type        = string
  default     = null
}

variable "transit_gateway_route_table_non_prod_id" {
  description = "Identifier of EC2 Transit Gateway Route Table to use with the Target Gateway when reusing it between multiple TGWs"
  type        = string
  default     = null
}
...
variable "share_with_organization" {
  description = "Whether the transit gateway is share with the whole organization"
  type        = bool
  default     = false
}
...
variable "create_route_table_prod" {
  description = "Whether to create a route table for the production domain"
  type        = bool
  default     = false
}

variable "create_route_table_non_prod" {
  description = "Whether to create a route table for the production domain"
  type        = bool
  default     = false
}

variable "route_table_prod_attachments" {
  description = "List transit gateway vpc attachments id to associate with the production route table"
  type = any
  default = []
}

variable "route_table_non_prod_attachments" {
  description = "List transit gateway vpc attachments id to associate with the production route table"
  type = any
  default = []
}
...
variable "create_tgw_route" {
  description = "Whether to create routes for the interconnect transit gateway route table"
  default = false
}


variable "create_tgw_route_prod" {
  description = "Whether to create routes for the production transit gateway route table"
  default = false
}

variable "create_tgw_route_non_prod" {
  description = "Whether to create routes for the non production transit gateway route table"
  default = false
}