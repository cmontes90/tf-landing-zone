...
variable "tgw_route" {
  description = "Controls if a route is created to direct traffic to internal network through a transit gateway attachment."
  type = bool
  default = false
}

variable "internal_network" {
  description = "CIDR block of the internal network, which is used when the tgw route is created"
  type = string
  default = null
}

variable "transit_gw_id" {
  description = "Identifies the transit gateway where the VPC needs to connect"
  type = string
  default = null
}